...
//                .tag(getString(R.string.global_tag))                   // Specify TAG, default: "X-LOG"
        ...
        //val filePrinter = FilePrinter.Builder(File(getExternalStorageDirectory(), "xrochakmasalefsmlogsample").path)// Printer that print the log to the file system
        val filePrinter = FilePrinter.Builder(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrochakmasalefsmlogsample").path)// Printer that print the log to the file system
...
//                .fileNameGenerator(ChangelessFileNameGenerator())        // Default: ChangelessFileNameGenerator("log")
                 ...
                 .backupStrategy(FileSizeBackupStrategy2(1024*1024*42,1))             // Default: FileSizeBackupStrategy(1024 * 1024)
