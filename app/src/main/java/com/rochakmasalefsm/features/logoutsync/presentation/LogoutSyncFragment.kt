package com.rochakmasalefsm.features.logoutsync.presentation
...
import com.rochakmasalefsm.app.AppDatabase
...
import com.rochakmasalefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.rochakmasalefsm.features.addshop.api.AddShopRepositoryProvider
import com.rochakmasalefsm.features.billing.api.AddBillingRepoProvider
import com.rochakmasalefsm.features.billing.model.AddBillingInputParamsModel
...
import com.rochakmasalefsm.features.dashboard.presentation.ReasonDialog
...
import com.rochakmasalefsm.features.document.model.AddEditDocumentInputParams
import com.rochakmasalefsm.features.document.model.DocumentAttachmentModel
...
import com.rochakmasalefsm.features.location.model.*
import com.rochakmasalefsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
...
import com.rochakmasalefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.rochakmasalefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.rochakmasalefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.rochakmasalefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.rochakmasalefsm.features.orderhistory.model.*
...
import com.rochakmasalefsm.features.quotation.model.AddQuotInputModel
import com.rochakmasalefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rochakmasalefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.rochakmasalefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.rochakmasalefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.rochakmasalefsm.features.timesheet.model.AddTimeSheetInputModel
import com.rochakmasalefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.rochakmasalefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.rochakmasalefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.rochakmasalefsm.mappackage.SendBrod
import com.rochakmasalefsm.widgets.AppCustomTextView
import com.rochakmasalefsm.MonitorService
import com.rochakmasalefsm.features.addshop.model.*
import com.rochakmasalefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.rochakmasalefsm.features.login.api.LoginRepositoryProvider
import com.rochakmasalefsm.features.login.model.GetConcurrentUserResponse
import com.rochakmasalefsm.features.returnsOrder.ReturnProductList
import com.rochakmasalefsm.features.returnsOrder.ReturnRequest
import com.rochakmasalefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrochakmasalefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrochakmasalefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrochakmasalefsmlogsample/log.zip").path);
